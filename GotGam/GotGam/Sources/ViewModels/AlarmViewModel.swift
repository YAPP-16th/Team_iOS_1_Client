...
class AlarmViewModel: CommonViewModel, AlarmViewModelType, AlarmViewModelInputs, AlarmViewModelOutputs {
    ...
    let got = Got(id: Int64(arc4random()), tag: .init(id: 1, name: "aaaa", color: "#123123"), title: "멍게", content: "test", latitude: .zero, longitude: .zero, isDone: false, place: "맛집", insertedDate: Date())
